...
const static double eV = 1.602176634 * pow(10, -19);	// elementary charge [J]
...
const static double dt_R = 2 * pow(10, -15);			// calculation time step [s]
const static double LC_R = 5.43 * pow(10, -10);		// lattice constant [m]
const static double L_R = 3 * LC_R;
const static double density_R = 0.5;
//---
...
const static double L = L_R / u_d;
const static double Lx = L;
const static double Ly = L;
const static double Lz = L;
const static double density = density_R / u_rho;
//---
